(function () {
    ...
    api.registerListener((id, data) => {
        ...
        let rawRollVal = row('Roll, raw');
        let rawPitchVal = row('Pitch, raw');
        api.addEl('div', 'hdg', page, 'Calibration');
        api.addEl('div', 'row', page,
            'Set the offsets under Config > icm20948. With the boat confirmed ' +
            'level, the "raw" values above should be the negative of the ' +
            'offset you need to enter.');

(function () {
    ...
    api.registerListener((id, data) => {
        ...
        let magRawVal = row('Raw (sensor frame) X/Y/Z');
        ...
        actionButton('Start', logButtonsRow, () => callAction('capControl', { action: 'start' }).catch((e) => alert('start failed: ' + e)));
        ...
        rateInput.max = 100;
        rateInput.value = 10;
        actionButton('Set rate', rateRow, () => callAction('capControl', { rateHz: rateInput.value }).catch((e) => alert('set rate failed: ' + e)));
